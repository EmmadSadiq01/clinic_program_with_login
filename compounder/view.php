...
<body>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div class='top-section'>
            <div class='id-section d-flex p-2 bd-highlight'>
                    <h3>ID:</h3>
                        <p>100" . $row['paitent_id'] . "</p>
                     </div>
        ...
        <div class='name-section d-flex p-2 bd-highlight'>

        <h4 id='name-heading'>Name: </h4>
        <div class='name-box'>
            <h3>" . $row['paitent_name'] . "</h3>
        </div>
        </div>

        <div class='description row m-2'>
        <div class='d-flex p-2 bd-highlight col-md-3 col-6'>
        ...
        <div class='col-md-6 col-12'>
            ...
            <p class='mt-2 text-field'>" . $row['diagnostics'] . "</p>
        </div>
        <div class='col-md-6 col-12'>
            <h3 class='text-heading'>
                Medicines:
            </h3>
            <p class='mt-2 text-field'>" . $row['meds'] . "</p>
        </div>
        </div>
        </div>
        <hr>";
