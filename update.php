...
if (isset($_GET['update'])) {
    ...
    // $sql = "SELECT * FROM `paitents_opd` WHERE `paitent_id`=$sno AND `datetime`=current_timestamp()" ;
    // $result = mysqli_query($connection, $sql);
    // while ($row = mysqli_fetch_array($result)) {

    //     $_SESSION['meds'] = $row['meds'];
    // }
    //     if ($result) {
    //         $insert = true;
    //     } else {
...
<body>
    ...
    echo "<div class='container hide header mt-2'>
    <h3>Paitent Name : <span id='paitentName'>" . $_SESSION['paitent_name'] . "</span></h3>
    <h3>ID : <span id='PaitentId'> 100" . $_SESSION['paitent_id'] . "</span></h3>
        ...
        <form action="/CMS/records.php" method="post">
            ...
            <div class="hide ml-3 form-group">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="diabetics" value="Yes">Diabetics1
                </label>
            </div>
            <!-- <div class="form-group">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="diabetics" value="diabetics2">Diabetics2
                </label>
            </div>
            <div class="form-group">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="diabetics" value="diabetics3">Diabetics3
                </label>
            </div> -->
            <div class="form-row">
